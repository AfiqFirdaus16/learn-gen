...
export default function MyVideosPage() {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6 dark:from-slate-950 dark:to-slate-900"><div className="mx-auto max-w-6xl space-y-6"><div className="flex items-center justify-between"><div><p className="text-sm font-semibold uppercase tracking-[0.3em] text-indigo-600">Riwayat generate</p><h1 className="text-3xl font-bold">Riwayat percobaan video</h1><p className="mt-2 text-sm text-slate-600 dark:text-slate-300">Prompt tersimpan untuk setiap percobaan, baik yang berhasil maupun gagal.</p></div><Link href="/dashboard"><Button variant="outline">Kembali ke dashboard</Button></Link></div>
